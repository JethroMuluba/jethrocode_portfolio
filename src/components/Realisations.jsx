...
function Realisations() {
  ...
  return (
   <section className=' w-full flex flex-col gap-8 items-center text-center py-[50px]'>
        ...
        <p className='text-[#8D9092]  px-6 md:p-0 '> {underTitle} </p>

        <div className=' w-full flex flex-col gap-4 text-left text-white px-6'>

            <div className='flex flex-col gap-2 py-[20px] px-[30px] bg-gradient-to-r from-[#25CDE9] to-[#247AE9] rounded-md  '>
            ...
            <div className='flex flex-col gap-2 py-[20px] px-[30px] bg-gradient-to-r from-[#EAC225] to-[#E69824] rounded-md  '>
                <img className='w-[35px]' src={iconeWebMobile} alt="icone Web & Mobile" />
            ...
            <div className='flex flex-col gap-2 py-[20px] px-[30px] bg-gradient-to-r from-[#E02F95] to-[#AB3AE0] rounded-md  '>
                <img className='w-[35px]' src={iconeWebMobile} alt="icone Web & Mobile" />
            ...
            <div className='flex flex-col gap-2 py-[20px] px-[30px] bg-gradient-to-r from-[#06B459] to-[#07C716] rounded-md  '>
                <img className='w-[35px]' src={iconeWebMobile} alt="icone Web & Mobile" />
