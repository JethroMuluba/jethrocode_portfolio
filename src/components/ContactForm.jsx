  ...
  return (
    <form onSubmit={handleSubmit(onSubmitForm)} className=' flex flex-col gap-[28px]'>
      <div className=' flex flex-col items-start  gap-2'>
        ...
        {errors.name && <span style={{color: '#DA5643', fontSize: '12px'}}>Name must have at least 3 letters</span>}
      </div>
      ...
      <div className=' flex flex-col gap-[28px]'>
        <div className=' flex flex-col items-start  gap-2'>
          ...
          {errors.phone && <span style={{color: '#DA5643', fontSize: '12px'}}>Phone is required</span>}
        </div>
        ...
        <div className=' flex flex-col items-start  gap-2'>
          ...
          {errors.email && <span style={{color: '#DA5643', fontSize: '12px'}}>Email must have at least 5 letters</span>}
        </div>
        ...
        <button type='submit' className=' bg-[#FEB633] hover:bg-[#303131] text-sm font-semibold hover:border hover:border-[#FEB633] text-white hover:text-[#FEB633] py-[14px] px-[50px] md:ml-0   rounded-md active:border-2 active:border-[#fff]'>Send Message </button>
      </div>
