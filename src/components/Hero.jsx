...
function Hero() {
  return (
    <section className='bg-[#2B2C2C] md:flex md:flex-col lg:flex lg:flex-row lg:justify-between  md:items-center md:px-[50px] lg:px-[150px]'>
        <div className=' md:flex md:flex-col md:gap-4 text-center md:text-center lg:text-left  text-white'>
            ...
            <button className=' bg-[#FEB633] text-sm font-semibold text-white py-[14px] px-[50px]  lg:mr-[450px]  rounded-md'>Contact</button>
        </div>
